 ...
 */
function parseSimpleDirective(name: string, value: string): FeedDirective {
 ...
 */
function parseBindDirective(name: string, value: string): FeedDirective {
 ...
 */
function parseEventDirective(name: string, value: string): FeedDirective {
