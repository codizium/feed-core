 ...
 */
function parseNodes(state: ParserState): FeedASTNode[] {
 ...
 */
function parseSlotElement(state: ParserState, token: Token): FeedASTNode {
  const attributes = token.attributes ?? {};
  const name = attributes['name'] || '';
  
  const children: FeedASTNode[] = [];
 ...
 */
function parseTemplateElement(state: ParserState, token: Token): FeedASTNode {
  const attributes = token.attributes ?? {};
 ...
 */
function parseRegularElement(state: ParserState, token: Token): FeedASTNode {
  const tagName = token.tagName ?? '';
  const attributes = token.attributes ?? {};
